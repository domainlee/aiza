...
$view = '<section class="single-page my-blog mb-5">
            <div class="col-12">
            ...
            <div class="col-10 col-md-8 offset-1 offset-md-2">
                <div class="single-post">
                        ...
                        <div class="post-author d-none">
                            <figure>
                                <a href="#"><img src="assets/images/17.jpg"></a>
                            </figure>
                                    ...
                                    <ol class="commentlist">
                                        <li id="li-comment-4">
                                            <article class="comment even thread-even depth-1 clr" id="comment-4">
                                                <div class="comment-author vcard"> <img width="60" height="60" src="assets/images/17.jpg" alt=""></div>
